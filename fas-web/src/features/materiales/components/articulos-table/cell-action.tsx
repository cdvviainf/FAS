...
import { deleteArticuloMutation } from '../../api/mutations';
...
export function CellAction({ data }: CellActionProps) {
  ...
  return (
    <>
      ...
      />
      <ArticuloFormSheet articulo={data} open={editOpen} onOpenChange={setEditOpen} />
