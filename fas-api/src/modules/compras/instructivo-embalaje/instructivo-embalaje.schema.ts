...
// El Instructivo no tiene estado propio (compras.md §4.1) — el PATCH acepta
// reemplazar el encabezado y/o el detalle completo en cualquier momento.
// Debe traer al menos un campo: un body vacío no representa ningún cambio.
