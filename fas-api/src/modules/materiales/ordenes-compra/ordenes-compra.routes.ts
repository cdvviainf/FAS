...
export async function ordenesCompraMaterialRoutes(app: FastifyInstance) {
  ...
  app.post('/ordenes-compra/:id/emitir', { preHandler: [requireAuth, requireLevel(ITEM, 'TOTAL')] }, ctrl.emitir)
